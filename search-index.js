...
const SEARCH_INDEX = [
  ...
  {
    "url": "instagram-designs.html",
    "title": "Instagram Post Designs",
    "pageTitle": "Instagram Post Designs",
    "category": "Spa Treatments",
    "content": "September Instagram Carousel Studio Complete 4-slide carousel in 4:5 portrait format (1080 × 1350 px), optimized for Instagram feed engagement with ready-to-copy caption. Your Seoul-Style Comeback Three September-only ways to firm, refine + reset. Seoul Glass Skin 360 Oligio X® 600 Shots + SkinTox Korean Scalp & Hair Reset 6 Sessions · Needle-Free · Peptides Seoul Youth Sculpt Radiesse® or HA · Facial + Neck SEOUL GLASS SKIN 360 Oligio X® 600 Targeted RF Shots paired with SkinTox for firmer, refined, glass-like radiance. KOREAN SCALP & HAIR RESET 6-Session needle-free scalp infusion program with peptides and red light for fuller-looking, revitalized hair. SEOUL YOUTH SCULPT Radiesse® or HA volume contouring designed to support facial architecture and refine the neck. 4-Slide Instagram Carousel Slide 1 serves as your high-converting cover post, followed by dedicated deep-dive slides for each of the three September aesthetic treatments.",
  ...
  },
  {
    ...
    "content": "Seoul-Level Scalp Care. Because Your Scalp Is Skin Too. K-Beauty transformed skincare by starting with the skin.At SuA Glow, we take that philosophy to the scalp. Personalized, physician-guided scalp & hair wellness combining Korean-inspired care, medical assessment and advanced technology for thinning-hair concerns, scalp health and healthier-looking hair.",
    "snippet": "Seoul-Level Scalp Care. Because Your Scalp Is Skin Too. K-Beauty transformed skincare by starting with the skin.At SuA Glow, we take that philosophy to the scal..."
  },
  {
    "url": "korean-scalp-hair-rejuvenation.html#scalp-reset-focus",
    "title": "YOUR PERSONALIZED SCALP RESET MAY FOCUS ON",
    "pageTitle": "Korean Scalp & Hair Rejuvenation Dallas",
    "category": "Korean Scalp & Hair Rejuvenation",
    "content": "Your plan is personalized around your scalp condition, hair-density concerns, goals and provider assessment. Every scalp journey starts with evaluating current density, barrier hydration, and individual follicular needs. For concerns such as dryness, oiliness, buildup or an unbalanced-looking scalp environment. Personalized care for areas where hair appears thinner, less full or where changes in density have become noticeable. Targeted topical scalp protocols may be incorporated based on your individualized treatment plan. Because Korean beauty is built around consistent care—not waiting until concerns become more noticeable. Stay ahead of future hair concerns with regular assessment and proactive personalized scalp care. Start with a personalized scalp consultation. Every plan is tailored to your unique scalp and hair density goals. Start with a personalized scalp consultation.",
    "snippet": "Your plan is personalized around your scalp condition, hair-density concerns, goals and provider assessment. Every scalp journey starts with evaluating current ..."
  },
  {
    ...
    "pageTitle": "Korean Scalp & Hair Rejuvenation Dallas",
    "category": "Korean Scalp & Hair Rejuvenation",
    "content": "Korean scalp care is a skin-first approach to scalp and hair wellness. At SuA Glow, we assess the scalp environment, visible thinning and hair-density concerns, existing hair quality and individual goals before developing a personalized treatment strategy. From there, an individualized Korean-inspired scalp strategy may incorporate scalp-care protocols, hydration and conditioning support, and needle-free topical scalp infusion when clinically appropriate. No mystery cocktail. No overnight hair-growth promises. No “everyone gets the same thing” protocol. Just personalized scalp care—with a little Seoul energy. Hair thinning and changes in hair density can have many causes. Treatment recommendations are based on individualized clinical assessment, medical history, candidacy, and treatment goals. When appropriate, additional medical, laboratory, or dermatologic evaluation may be recommended.",
    "snippet": "Korean scalp care is a skin-first approach to scalp and hair wellness. At SuA Glow, we assess the scalp environment, visible thinning and hair-density concerns,..."
  },
  {
    "url": "korean-scalp-hair-rejuvenation.html#method",
    "title": "K-BEAUTY CHANGED SKINCARE. NOW THINK SCALP.",
    "pageTitle": "Korean Scalp & Hair Rejuvenation Dallas",
    "category": "Korean Scalp & Hair Rejuvenation",
    "content": "The same skin-first philosophy—brought a little higher. K-Beauty thinks ahead. Your scalp deserves the same. Different needs call for different approaches. Scalp care shouldn't start and stop with one visit. A personalized, physician-guided approach designed around your scalp and goals. Scalp. Density. History. Goals. Cleanse. Condition. Prep. Targeted care + needle-free infusion when appropriate. Reassess. Refine. Maintain.",
    "snippet": "The same skin-first philosophy—brought a little higher. K-Beauty thinks ahead. Your scalp deserves the same. Different needs call for different approaches. Scal..."
  },
  {
    ...
    "pageTitle": "Korean Scalp & Hair Rejuvenation Dallas",
    "category": "Korean Scalp & Hair Rejuvenation",
    "content": "Advanced infusion. Targeted results. All part of your personalized scalp & hair plan. Specialized infusion technology delivers actives where they matter—no injections. Customized protocols for hydration, balance and scalp wellness. Healthier-looking scalp. Stronger-feeling hair. Real results over time. Medical Aesthetic Philosophy Not every scalp treatment delivers dramatic growth. We do not position Needle-Free Scalp Infusion as a guaranteed solution or replacement for medically indicated hair-loss evaluation or treatment. Scalp hydration & conditioning Scalp balance & environment Stronger-looking, healthier-feeling hair Overall scalp & hair wellness goals",
    "snippet": "Advanced infusion. Targeted results. All part of your personalized scalp & hair plan. Specialized infusion technology delivers actives where they matter—no inje..."
  },
  {
    "url": "korean-scalp-hair-rejuvenation.html#concerns",
    "title": "YOUR SCALP DOESN'T NEED A CRISIS. JUST A REASON TO CHECK IN.",
    "pageTitle": "Korean Scalp & Hair Rejuvenation Dallas",
    "category": "Korean Scalp & Hair Rejuvenation",
    "content": "Korean Scalp & Hair Rejuvenation at SuA Glow is designed for women and men with visible scalp, thinning or hair-density concerns—or those simply looking for a more proactive approach to scalp wellness. Wider-looking part • Less fullness • Visible thinning Dry • Oily • Flaky • Buildup-prone Hairline • Temples • Crown • Hair quality Hair thinning, shedding and changes in hair density can have different causes. When appropriate, your provider may recommend additional medical, laboratory or dermatologic evaluation. You don't need to diagnose the concern yourself. Your consultation starts with understanding what's changed—and whether aesthetic scalp care is appropriate for you. Hair thinning and shedding can have many causes. Sudden, significant, patchy, persistent or symptomatic changes may warrant additional medical or dermatologic evaluation before aesthetic scalp treatment. We'll help determine the appropriate next step. Rapid or significant thinning or shedding. Changes that don't follow a typical pattern. Symptoms or dermatologic concerns. Medication, nutritional, hormonal or other health factors.",
    "snippet": "Korean Scalp & Hair Rejuvenation at SuA Glow is designed for women and men with visible scalp, thinning or hair-density concerns—or those simply looking for a m..."
  },
  {
  ...
  },
  {
    ...
    "content": "Premier Korean Glass Skin Facial Experience one of Korea's most sought-after facial treatments. Using advanced LDM multi-frequency ultrasound, Water Drop Lifting deeply hydrates the skin, strengthens the skin barrier, calms inflammation, refines pores, and restores luminous glass skin without needles or downtime.",
    "snippet": "Premier Korean Glass Skin Facial Experience one of Korea's most sought-after facial treatments. Using advanced LDM multi-frequency ultrasound, Water Drop Liftin..."
  },
  {
  ...
  },
  {
    ...
    "pageTitle": "Korean LDM Facial Dallas",
    "category": "Ultrasound Premier Korean Glass Skin Lifting",
    "content": "In Korean aesthetics, \"Water Drop Lifting\" describes hydration-focused skin rejuvenation approaches designed to reveal smoother texture, refined glow, and healthy elasticity without harsh downtime. Hydrated skin appears smoother, brighter, more refined, and naturally radiant. In Seoul aesthetics, this luminous, dewy finish became known as the \"Water Drop Glow,\" the ultimate hallmark of healthy, foundation-free skin that looks rested and youthful every single day. Unlike traditional procedures that rely on harsh resurfacing or thermal trauma, LDM Water Drop Lifting works in harmony with your skin's natural biology to restore deep moisture reserves, calm inflammation, and lock in long-term barrier protection. Smoother texture & refined pore structure Natural radiance & skin bounce Calm elasticity & barrier support Zero downtime & needle-free comfort Three targeted phases powered by multi-frequency ultrasound to flood, restore, and illuminate your skin. Using dual-frequency ultrasound technology, LDM delivers intense moisture deep into the dermal layers, recharging cellular water reserves and improving skin bounce instantly. Calms inflammation and balances extracellular matrix proteins (MMPs and GAGs) to fortify your natural skin barrier, preventing moisture loss and supporting long-term skin resilience. Post-treatment skin looks visibly smoothed, deeply plumped, and naturally luminous with a calm, dewy glass skin finish, with zero downtime or redness.",
  ...
  },
  {
    ...
    "title": "LDM Water Drop FAQs",
    "pageTitle": "Korean LDM Facial Dallas",
    "category": "Ultrasound Premier Korean Glass Skin Lifting",
    "content": "The Korean Glass Skin LDM Facial is a Korean-inspired non-invasive multi-mode skin rejuvenation treatment focused on hydration-conscious rejuvenation, glow-focused maintenance, healthier-looking skin quality, texture and tone-focused refinement, refined pore appearance, and skin barrier support. Water Drop Lifting is a Korean-inspired hydration-focused skin rejuvenation concept focused on smoother-looking texture, balanced hydration, healthier-looking skin bounce, refined glow, brighter tone, and refined pore appearance. Korean aesthetics prioritizes healthier-looking skin quality, smoother texture, brighter tone, refined pore appearance, and prevention-focused maintenance because healthier-looking skin reduces the appearance of needing heavy makeup or aggressive correction. Korean LDM Facial treatments focus on multi-frequency ultrasound technology, hydration-conscious rejuvenation, skin barrier support, glow-focused maintenance, and personalized skin management strategies rather than aggressive overprocessing approaches. Many patients pursue Korean-inspired skin rejuvenation treatments as part of a broader \"glass skin\" strategy focused on smoother texture, balanced hydration, healthier skin bounce, refined glow, brighter tone, and subtle radiance. Electroporation-based skin rejuvenation technologies are commonly utilized to support enhanced topical solution infusion and hydration-focused skin maintenance without needle injections. Yes. Treatment recommendations are individualized based on skin condition and clinical assessment. Korean-inspired skin rejuvenation approaches prioritize gentler, hydration-conscious treatment planning suitable for sensitive skin. Many patients experience no downtime depending on individualized treatment planning and skin sensitivity. You can apply sunscreen or makeup and immediately return to your daily schedule. Korean beauty philosophy prioritizes hydration balance, skin barrier maintenance, subtle refinement, and long-term skin quality because healthier-looking skin is viewed as the true foundation of beauty. SuA Glow Med Spa in Carrollton offers Korean-inspired Glass Skin LDM Facial treatments for patients across Dallas, Plano, Frisco, Coppell, Irving, Southlake, Grapevine, Richardson, Addison, and Fort Worth.",
  ...
  },
  {
    ...
    "content": "Elevated by Korean Expertise. FDA-cleared medical microneedling designed to stimulate collagen renewal, remodel acne scars, refine pore structure, and support natural-looking glass skin rejuvenation without surgery or extended downtime. Exclusively available at SuA Glow, Dallas-Fort Worth's premier authorized Korean aesthetic rejuvenation destination.",
    "snippet": "Elevated by Korean Expertise. FDA-cleared medical microneedling designed to stimulate collagen renewal, remodel acne scars, refine pore structure, and support n..."
  },
  {
    ...
    "pageTitle": "SkinPen Microneedling Dallas",
    "category": "The Seoul Skin Quality Philosophy",
    "content": "Glass Skin starts with texture. Beautiful skin is about skin health first, not aggressive resurfacing. Korean aesthetics changed how patients think about skin rejuvenation. The goal is no longer: “Can everyone tell I had treatment?” but rather: “How does her skin always look so smooth?” At SuA Glow Med Spa in Carrollton, SkinPen® Microneedling was selected because modern skin rejuvenation focuses on collagen support, skin barrier respect, and gradual texture refinement. Our K-Glow approach helps skin appear smoother, brighter, and naturally radiant without looking artificial or overprocessed. Skin Texture Focus",
    "snippet": "Glass Skin starts with texture. Beautiful skin is about skin health first, not aggressive resurfacing. Korean aesthetics changed how patients think about skin r..."
  },
  {
    "url": "microneedling.html#why-skinpen",
    "title": "WHY WE CHOSE SKINPEN®",
    "pageTitle": "SkinPen Microneedling Dallas",
    "category": "The Seoul Skin Quality Philosophy",
    "content": "Not all microneedling devices undergo the same regulatory review process. At SuA Glow, SkinPen® was intentionally selected because FDA-cleared technology supports: Consistency and safety-focused skin renewal Controlled, precise treatment delivery Predictable and reliable needle depth control Skin integrity-focused rejuvenation Because healthier-looking skin should never come at the expense of skin health. The SuA Glow Seoul Standard elevates every SkinPen® treatment. We combine FDA-cleared technology with Korean skin philosophy to support long-term results: Intelligent, natural collagen support and remodeling Acne scar and rolling/boxcar scar refinement Respect for the skin barrier while calming inflammation Glass skin texture quality and prevention-first aesthetics Because smoother skin without healthier skin is not true luxury.",
  ...
  },
  {
    ...
    "content": "Korean RF skin tightening designed to support collagen renewal, skin firmness, jawline definition, and natural-looking rejuvenation without surgery or extended downtime. Exclusively available at SuA Glow, Dallas-Fort Worth's first authorized Oligio X provider.",
    "snippet": "Korean RF skin tightening designed to support collagen renewal, skin firmness, jawline definition, and natural-looking rejuvenation without surgery or extended ..."
  },
  {
  ...
  },
  {
    ...
    "pageTitle": "Oligio X RF Lifting Dallas",
    "category": "Korean Aesthetic Philosophy",
    "content": "Monopolar RF Technology Long Clinical History Tightening & Collagen Support OUR PERSPECTIVE Thermage helped establish RF skin tightening globally. We selected Oligio X because we wanted the latest evolution of Korean RF technology and a platform aligned with our Seoul-inspired treatment approach. Multiple RF Frequencies Multi-Depth Energy Delivery Collagen Remodeling Focus OUR PERSPECTIVE XERF utilizes a different RF approach designed to address multiple tissue depths. We selected Oligio X because it reflects the treatment philosophy, workflow, and patient experience we wanted to bring to SuA Glow. Ultrasound-Based Energy Often Selected for Deeper Lifting Different Mechanism Than RF OUR PERSPECTIVE Ultherapy is often considered when deeper lifting support is the primary goal. Our focus is often skin quality, collagen support, contour refinement, and natural-looking rejuvenation. Every treatment plan is customized based on: The best technology is the one selected for your face—not someone else's.",
    "snippet": "Monopolar RF Technology Long Clinical History Tightening & Collagen Support OUR PERSPECTIVE Thermage helped establish RF skin tightening globally. We selected O..."
  },
  {
    "url": "oligio-x.html#showcase-banner",
    "title": "RF Lifting",
    "pageTitle": "Oligio X RF Lifting Dallas",
    "category": "Korean Aesthetic Philosophy",
  ...
  },
  {
    ...
    "pageTitle": "Oligio X RF Lifting Dallas",
    "category": "Korean Aesthetic Philosophy",
    "content": "Oligio became one of South Korea's leading monopolar RF technologies by focusing on collagen support and natural-looking rejuvenation. Oligio X builds upon that foundation with: Updated Platform Design Enhanced Treatment Customization Refined Treatment Workflows Increased Power Delivery Next-Generation User Experience",
    "snippet": "Oligio became one of South Korea's leading monopolar RF technologies by focusing on collagen support and natural-looking rejuvenation. Oligio X builds upon that..."
  },
  {
    "url": "oligio-x.html#alternatives-philosophy",
  ...
  {
    "url": "oligio-x.html#post-treatment-guide",
  ...
  },
  {
    ...
    "pageTitle": "Korean Tone-Up Facial Dallas",
    "category": "K-BEAUTY • BRIGHTENING • RADIANCE",
    "content": "Think of these treatments as complementary parts of the Korean Glass Skin journey. The Korean Brightening Glass Skin Tone-Up Facial at SuA Glow may incorporate: Treatment strategies are individualized based on:",
