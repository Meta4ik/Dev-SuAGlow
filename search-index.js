...
const SEARCH_INDEX = [
  ...
  },
  {
    ...
    "snippet": "Losing weight should never mean losing your confidence—or your skin quality. At SuA Glow, our Physician-Guided Body Reset was created for people who want more t..."
  },
  {
    ...
    "pageTitle": "Medical Weight Loss Dallas, Compounded GLP-1 Body Reset",
    "category": "PHYSICIAN-GUIDED BODY RESET • K-BEAUTY METABOLIC WELLNESS",
    "content": "That's why patients across Carrollton, Plano, Frisco, Coppell, Irving, Lewisville, Farmers Branch, Addison, and the DFW Metroplex choose SuA Glow for physician-guided Body Reset care that goes beyond the scale. Restore cellular energy, support metabolic efficiency, and feel vibrant in your everyday routine. Feel empowered walking into any room with a healthy body composition and refreshed appearance. Maintain firm skin elasticity, natural volume, and a calm, radiant glow as your contours change. Not Smaller Stronger Not Thinner Healthier Not Perfection Balance Healthy Skin • Healthy Body • Healthy Confidence That's the glow we're after. Personalized medical care designed around your body—not someone else's journey. Evidence-based medical weight management tailored to your individual needs. A philosophy that prioritizes healthy skin, balanced wellness, and sustainable confidence. Strategies focused on healthy body composition and preserving lean muscle during weight loss. Oligio X® skin tightening for the face and body may be incorporated into your personalized treatment plan to help support skin firmness as your body changes. Targeted nutraceuticals and wellness infusions may be recommended to support hydration, nutrition, and overall wellness throughout your journey. Because the goal isn't simply to lose weight—it's to look refreshed, feel stronger, and glow with confidence.",
