const OVERSIGHT_HTML = `
    ...
    <section class="py-10 md:py-14 px-6 md:px-12 lg:px-16 bg-light-gray">
        <div class="max-w-5xl mx-auto">
            <div class="relative bg-white pt-5 pb-6 px-6 sm:pt-6 sm:pb-8 sm:px-8 md:pt-7 md:pb-9 md:px-10 shadow-soft rounded-[2rem] border border-light-gray/40 overflow-hidden animate-on-scroll fade-up">
                <!-- Background accent element -->
                <div class="absolute -right-10 -bottom-10 w-48 h-48 bg-[#AA987C]/5 rounded-full blur-2xl pointer-events-none"></div>
                
                <!-- Floated Texas Compliant Circular Seal in Upper-Right Corner -->
                <div class="absolute top-4 right-4 sm:top-5 sm:right-6 md:top-6 md:right-8 z-20 group flex items-center justify-center text-[#AA987C] w-16 h-16 sm:w-20 sm:h-20 md:w-[86px] md:h-[86px] cursor-default pointer-events-auto" title="Texas Compliant Medical Practice">
                    ...
                    <svg viewBox="0 0 100 100" class="w-full h-full relative z-10 transition-transform duration-700 group-hover:rotate-45">
                        <defs>
                            <path id="txCirclePath" d="M 50, 50 m -35, 0 a 35,35 0 1,1 70,0 a 35,35 0 1,1 -70,0" />
                        </defs>
                    ...
                    <div class="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
                        <svg viewBox="0 0 200 200" class="w-7 h-7 sm:w-9 sm:h-9 md:w-10 md:h-10 text-[#AA987C]" fill="currentColor">
                ...
                <div class="space-y-3.5 relative z-10">
                    <div class="pr-18 sm:pr-24 md:pr-28">
                    ...
                    <p class="text-xs sm:text-sm font-light text-charcoal/80 leading-relaxed pr-18 sm:pr-24 md:pr-28 [text-wrap:pretty]">
