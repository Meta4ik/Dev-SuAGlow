    ...
    <section class="py-10 md:py-14 px-6 md:px-12 lg:px-16 bg-light-gray">
        <div class="max-w-5xl mx-auto">
            <div class="relative bg-white p-6 sm:p-8 md:p-10 shadow-soft rounded-[2rem] border border-light-gray/40 overflow-hidden animate-on-scroll fade-up">
                ...
                <div class="absolute top-6 right-6 sm:top-8 sm:right-8 md:top-10 md:right-10 z-20 group flex items-center justify-center text-[#AA987C] w-16 h-16 sm:w-20 sm:h-20 md:w-[86px] md:h-[86px] cursor-default pointer-events-auto" title="Texas Compliant Medical Practice">
