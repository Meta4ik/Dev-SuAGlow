                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="flex items-center gap-4 sm:gap-5 p-4 sm:p-5 rounded-2xl border border-light-gray/30 shadow-xs" style="background: radial-gradient(circle at center, rgba(255,255,255,1) 0%, rgba(233,233,229,0.8) 100%);">
                            <img src="${p1Img}" alt="${p.provider1Name}" class="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover shrink-0 border-2 border-white shadow-md">
                            <div>
                                <p class="text-sm sm:text-base font-semibold text-near-black leading-tight">${p.provider1Name}</p>
                                <p class="text-[10px] sm:text-[11px] uppercase tracking-wider text-taupe/90 font-medium mt-1.5">${p.provider1Title}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-4 sm:gap-5 p-4 sm:p-5 rounded-2xl border border-light-gray/30 shadow-xs" style="background: radial-gradient(circle at center, rgba(255,255,255,1) 0%, rgba(233,233,229,0.8) 100%);">
                            <img src="${p2Img}" alt="${p.provider2Name}" class="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover shrink-0 border-2 border-white shadow-md">
                            <div>
                                <p class="text-sm sm:text-base font-semibold text-near-black leading-tight">${p.provider2Name}</p>
                                <p class="text-[10px] sm:text-[11px] uppercase tracking-wider text-taupe/90 font-medium mt-1.5">${p.provider2Title}</p>
                            </div>
                        </div>
                    </div>
...
<section id="skintox" class="py-28 px-8 md:px-12 bg-off-white">
    ...
    'consultation-policy': {
        ...
        render: (p = {}) => `
<section id="consultation-policy" class="py-6 md:py-8 bg-white relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-[#F6F3EE] rounded-[1.75rem] md:rounded-[2rem] overflow-hidden border border-[#E8DFC8]/60 shadow-soft w-full min-h-[450px] md:min-h-[360px] lg:min-h-[380px] flex items-center">
            ...
            <div class="relative z-10 w-full lg:w-[56%] h-full flex flex-col justify-between p-5 sm:p-6 md:p-7 lg:p-8">
                
                <div class="space-y-2.5 sm:space-y-3 max-w-lg">
                    <!-- Top Tagline -->
                    <span class="inline-block text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.2em] md:tracking-[0.22em] text-[#9C8C7C]">
                        ${p.badgeText}
                    </span>
                    
                    <!-- Headline: Desktop (2 lines) / Mobile Sample (3 lines) -->
                    <h2 class="heading-wide text-2xl sm:text-[28px] lg:text-[32px] xl:text-[36px] text-near-black uppercase tracking-[0.14em] md:tracking-[0.15em] leading-[1.15] font-light">
                    ...
                    <p class="font-body text-[11px] sm:text-[12.5px] lg:text-[13px] text-[#696259] font-light leading-relaxed max-w-[270px] sm:max-w-[390px] uppercase md:normal-case tracking-wider md:tracking-normal">
                        ${p.description}
                    </p>
                    
                    <!-- $50 Consultation Fee: Mobile Stacked Card (matching mobile sample) -->
                    <div class="flex md:hidden flex-col gap-1.5 bg-[#EDE7DF] border border-[#E2DBD1]/80 p-3 rounded-2xl shadow-xs w-fit max-w-[190px]">
                        ...
                        <div class="w-full h-px bg-[#D5CCC0] my-0.5"></div>
                    ...
                    <div class="hidden md:inline-flex items-center gap-4 sm:gap-5 bg-[#EDE7DF] border border-[#E2DBD1]/80 px-4.5 py-2.5 sm:px-5 sm:py-2.5 rounded-2xl shadow-xs w-fit">
                        <div class="flex items-center gap-2.5">
                            <span class="text-3xl sm:text-[32px] font-bold text-[#1B1E21] tracking-tight leading-none">${p.feeAmount}</span>
                            <span class="text-[10px] sm:text-[10.5px] font-bold uppercase tracking-[0.12em] text-[#635A50] leading-none">${p.feeLabel}</span>
                        </div>
                        
                        <div class="w-px h-7 bg-[#D5CCC0]"></div>
                        
                        <div class="text-[9px] sm:text-[9.5px] font-bold uppercase tracking-[0.1em] text-[#786F64] leading-[1.2]">
                    ...
                    <div class="pt-0.5 sm:pt-1">
                        <a href="${p.ctaLink}" target="_blank"
                           class="inline-flex items-center justify-center gap-2.5 sm:gap-3 bg-[#1B1E21] hover:bg-[#2C2E30] text-white px-5 sm:px-7 py-2.5 sm:py-3 rounded-full text-[11px] sm:text-xs font-semibold tracking-[0.14em] uppercase transition-all duration-300 shadow-sm hover:scale-[1.02] active:scale-[0.98] w-fit">
                            <span>${p.ctaText}</span>
                ...
                <div class="pt-4 sm:pt-5 flex items-center gap-3 w-full">
                    <span class="text-[8.5px] sm:text-[9.5px] font-bold tracking-[0.18em] sm:tracking-[0.2em] text-[#8E8072] uppercase whitespace-nowrap">
                        ${p.tagline}
                    </span>
