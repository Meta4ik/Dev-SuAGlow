...
<section id="consultation-policy" class="py-6 md:py-8 bg-white relative overflow-hidden">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-[#F6F3EE] rounded-[1.75rem] md:rounded-[2rem] overflow-hidden border border-[#E8DFC8]/60 shadow-soft w-full min-h-[380px] lg:h-[400px] flex items-center">
            ...
            <!-- Model Image on Right: 1:1 matching the reference position & full opacity -->
            <div class="absolute inset-y-0 right-0 w-full sm:w-[54%] lg:w-[52%] z-0 pointer-events-none">
                <img src="${p.imageSrc}" 
                     alt="SuA Glow Personalized Aesthetic Consultation" 
                     class="w-full h-full object-cover object-[75%_top] sm:object-[70%_20%] lg:object-[68%_15%]">
            </div>
            ...
            <div class="relative z-10 w-full lg:w-[56%] h-full flex flex-col justify-between p-6 sm:p-8 md:p-10 lg:p-11">
                ...
                <div class="space-y-3 sm:space-y-4 max-w-lg">
                    ...
                    <!-- Headline: Exact 2 lines matching the reference -->
                    <h2 class="font-sans text-3xl sm:text-4xl lg:text-[42px] xl:text-[46px] leading-[1.08] text-[#1B1E21] font-light tracking-[-0.01em]">
                        ${p.title}
                    </h2>
