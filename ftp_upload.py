...
# Exclude list
EXCLUDE = {'.git', 'node_modules', 'src', 'scratch', 'dev-tools', 'kam_doc_updates', '.env', 'ftp_upload.py', 'package.json', 'package-lock.json', '.DS_Store', 'DEPLOYMENT.md', 'search-index.js', 'extract_logos.py', '.gitignore', 'iv-infusion-wellness-therapy.html'}
