...
const MONTHLY_SPECIALS_CONFIG_SEPTEMBER = {
    ...
    meta: {
        ...
        tagline: "Dallas summer steal your glow? K-Beauty to the rescue. Your Seoul-style comeback starts at SuA Glow.",
        offerCallout: "AUTHENTIC K-BEAUTY • KOREAN PA-C PROVIDER • KOREAN EXPERTISE",
        flyerImage: "assets/september_flyer_bg_models.jpg",
        cardBackground: "assets/dallas_fall_card_bg.jpg",
    ...
    featuredSteps: [
        ...
        },
        {
            ...
            subtitle: "Radiesse® · Facial Volume · Neck Refinement",
            price: "$990",
            originalPrice: "$1,300",
            ...
            tags: ["Radiesse®", "Facial Volume", "Neck Refinement"],
            bookingUrl: "https://suaglow.myaestheticrecord.com/online-booking/"
        }
    ],
